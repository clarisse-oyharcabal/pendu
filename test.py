...
pend = pygame.image.load("img/pend.png").convert_alpha()  # Charger pend.png avec transparence
...
pend = pygame.transform.scale(pend, (100, 250))  # pend: 100 x 250 (plus long)
...
def game_loop():
    ...
    flot_speed = -2  # Vitesse de défilement (négative pour aller vers la gauche)
    ...
    while True:
        ...
        # Dessine pend.png à gauche de man.png et partant du haut de la fenêtre
        screen.blit(pend, (220 - 120, -50))  # Positionne pend.png
