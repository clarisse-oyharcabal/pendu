...
fish_img       = load_image("fish.png", (80, 120))
...
# Logo displayed below the best score
logo_w_img     = load_image("logow.png", (120, 40))

# Load 20 emojis, each scaled to full-screen
emoji_images = []
for i in range(1, 21):
    fname = f"emoji{i}.png"  # e.g. "emoji1.png", "emoji2.png", ...
...
pulse_sound          = load_sound("pulse.wav")      # "beating" sound for each emoji
...
win_sound            = load_sound("win.wav")        # Loop this on "You Win!"
lose_sound           = load_sound("lose.wav")
chrono_endanger_sound= load_sound("chronoendanger.wav")
...
class PendulumGame:
    ...
    def draw(self, surface):
        ...
        # Logo
        surface.blit(logo_w_img, (WIDTH - 200, y_offset_for_logo))
        y_offset_for_logo += logo_w_img.get_height() + 5
